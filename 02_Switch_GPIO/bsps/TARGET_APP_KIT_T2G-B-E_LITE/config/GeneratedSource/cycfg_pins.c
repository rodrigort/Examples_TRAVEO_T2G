...
const cy_stc_gpio_pin_config_t BTN_2_config =
{
    .outVal = 1,
...
const cyhal_resource_inst_t BTN_2_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = BTN_2_PORT_NUM,
    .channel_num = BTN_2_PIN,
};
...
const cy_stc_gpio_pin_config_t CYBSP_SWDOE_config =
{
    .outVal = 1,
    .driveMode = CY_GPIO_DM_PULLUP,
    .hsiom = CYBSP_SWDOE_HSIOM,
    .intEdge = CY_GPIO_INTR_DISABLE,
    .intMask = 0UL,
    .vtrip = CY_GPIO_VTRIP_CMOS,
    .slewRate = CY_GPIO_SLEW_FAST,
...
#if defined (CY_USING_HAL) || (CY_USING_HAL_LITE)
const cyhal_resource_inst_t CYBSP_SWDOE_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = CYBSP_SWDOE_PORT_NUM,
    .channel_num = CYBSP_SWDOE_PIN,
};
#endif /* defined (CY_USING_HAL) || (CY_USING_HAL_LITE) */

const cy_stc_gpio_pin_config_t LED_1_config =
{
    .outVal = 1,
    .driveMode = CY_GPIO_DM_STRONG_IN_OFF,
    .hsiom = LED_1_HSIOM,
...
#if defined (CY_USING_HAL) || (CY_USING_HAL_LITE)
const cyhal_resource_inst_t LED_1_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = LED_1_PORT_NUM,
    .channel_num = LED_1_PIN,
};
#endif /* defined (CY_USING_HAL) || (CY_USING_HAL_LITE) */

const cy_stc_gpio_pin_config_t LED_2_config =
{
    .outVal = 1,
    .driveMode = CY_GPIO_DM_STRONG_IN_OFF,
    .hsiom = LED_2_HSIOM,
...
#if defined (CY_USING_HAL) || (CY_USING_HAL_LITE)
const cyhal_resource_inst_t LED_2_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = LED_2_PORT_NUM,
    .channel_num = LED_2_PIN,
};
#endif /* defined (CY_USING_HAL) || (CY_USING_HAL_LITE) */

const cy_stc_gpio_pin_config_t BTN_1_config =
{
    .outVal = 1,
    .driveMode = CY_GPIO_DM_PULLUP,
    .hsiom = BTN_1_HSIOM,
...
#if defined (CY_USING_HAL) || (CY_USING_HAL_LITE)
const cyhal_resource_inst_t BTN_1_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = BTN_1_PORT_NUM,
    .channel_num = BTN_1_PIN,
};
#endif /* defined (CY_USING_HAL) || (CY_USING_HAL_LITE) */

void init_cycfg_pins(void)
{
    Cy_GPIO_Pin_Init(BTN_2_PORT, BTN_2_PIN, &BTN_2_config);
    ...
    Cy_GPIO_Pin_Init(CYBSP_SWDOE_PORT, CYBSP_SWDOE_PIN, &CYBSP_SWDOE_config);
    Cy_GPIO_Pin_Init(LED_1_PORT, LED_1_PIN, &LED_1_config);
    Cy_GPIO_Pin_Init(LED_2_PORT, LED_2_PIN, &LED_2_config);
    Cy_GPIO_Pin_Init(BTN_1_PORT, BTN_1_PIN, &BTN_1_config);
}
void reserve_cycfg_pins(void)
{
#if defined (CY_USING_HAL)
    cyhal_hwmgr_reserve(&BTN_2_obj);
    ...
    cyhal_hwmgr_reserve(&CYBSP_SWDOE_obj);
    cyhal_hwmgr_reserve(&LED_1_obj);
    cyhal_hwmgr_reserve(&LED_2_obj);
    cyhal_hwmgr_reserve(&BTN_1_obj);
