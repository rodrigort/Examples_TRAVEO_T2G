...
#if !defined(CYT2BL5CAS)
#error "Unexpected MPN; expected DEVICE:=CYT2BL5CAS. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(CYT2BL5CAS) */
